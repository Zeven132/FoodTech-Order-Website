<?php
    ...
    {
        echo '<tr><td id="RowID">'.$row['RowID'].'</td><td id="TeacherCode">'.$row['TeacherCode']."</td><td>".$row['PracticalDay']."</td><td>".$row['Class']."</td><td>".$row['RoomNum']."</td><td>".$row['Recipe']."</td><td>".$row['NumOfStudents']."</td><td>".$row['Block'].'</td><td id="Baking">'.$row['Baking']."</td><td>".$row['Bread']."</td><td>".$row['Chilled']."</td><td>".$row['Dairy']."</td><td>".$row['Dried']."</td><td>".$row['Fresh']."</td><td>".$row['Frozen']."</td><td>".$row['Other']."</td><td>".$row['Raw']."</td><td>".$row['Sauces']."</td><td>".$row['Tinned']."</td><td>".$row['Vegetables']."</td><td>".$row['TechnicianReq']."</td></tr>"/*The recipe for today: " . $row['Recipe']. " with a side of " .$row['Tinned']*/;
    }
    echo "</table";
        ...
        <script>
          /*  window.onload = ReadTable();
            ...
            async function ReadTable()
            {
                ...
                ConvertJSONToText(document.getElementById("baking").innerHTML);
            }*/
        </script>
    </head>
</html>
